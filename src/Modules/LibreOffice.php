...
class LibreOffice
{
    ...
    /**
     * Tells Sideol to use unoconv for converting the resulting PDF(s) to
     * the "PDF/A-1a" format.
     *
     * @deprecated
     */
    ...
    /**
     * Tells Sideol to use unoconv for converting the resulting PDF to a PDF
     * format.
     */
    ...
    /**
     * Converts the given document(s) to PDF(s). Sideol will return either
